...
model = tf.keras.models.load_model('lstm_energy.keras')
scaler_X = pickle.load(open('lstm_scaler_X', 'rb'))
scaler_y = pickle.load(open('lstm_scaler_y', 'rb'))
...
hdf5storage.write(matfiledata, '.', 'lstm_prediction.mat', matlab_compatible=True)